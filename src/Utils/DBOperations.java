...
public class DBOperations {
    ...
    public static Statement establish_connection() throws SQLException {
        try {
            ...
            statement.executeUpdate("CREATE TABLE Guest (" + "Name VARCHAR(30), " + "Surname VARCHAR(30),"
                    + " Date DATE," + "Email VARCHAR, "
                    + "Phone_Number VARCHAR(10)," + "Confirm INTEGER)");
        }
        return statement;
    }
    ...
    public static int Add_Guest(Statement statement, String Name, String Surname, String Date, String Email,
                                String Phone, String Confirm)
            throws SQLException {
        try {
            System.out.println("\n- Writing database...");
            return AddGuest(statement, Name, Surname, Date, Email, Phone, String.valueOf(Boolean.parseBoolean(Confirm)));
        } catch (SQLException e) {
            System.out.println("Something went wrong... " + e.getMessage());
            return 0;
        }
    ...
    public static int AddGuest(Statement statement, String Name, String Surname, String Date, String Email,
                               String Phone, String Confirm)
            throws SQLException {
        int a;
        if (Confirm.equals("true")) {
            a = statement.executeUpdate("INSERT INTO 'Guest'(Name,Surname,Email,Phone_Number,Confirm,Date) " +
                    "VALUES('" + Name + "','" + Surname + "','" + Email + "','" + Phone + "','" + 1 + "','" + Date + "')");
        } else {
            a = statement.executeUpdate("INSERT INTO 'Guest'(Name,Surname,Email,Phone_Number,Confirm,Date) " +
                    "VALUES('" + Name + "','" + Surname + "','" + Email + "','" + Phone + "','" + 0 + "','" + Date + "')");
        }
        return a;
    }
